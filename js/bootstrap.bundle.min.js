...
!(function (t, e) {
      ...
      : Qt(
          (function (t) {
            var e,
              ...
              l = -n.scrollTop;
            return (
              "rtl" === Et(s || i).direction && (a += xt(i.clientWidth, s ? s.clientWidth : 0) - o),
  ...
  function le(t, e, i) {
    ...
    return (
      (o || (!o && !i)) &&
        (("body" !== dt(e) || Xt(a)) &&
          (c = (n = e) !== ut(n) && pt(n) ? { scrollLeft: (s = n).scrollLeft, scrollTop: s.scrollTop } : Vt(n)),
  ...
  class si extends H {
    ...
    show() {
      ...
      if (P.trigger(this._element, "show.bs.tab", { relatedTarget: t }).defaultPrevented || (null !== s && s.defaultPrevented))
        return;
    ...
    _activate(t, e, i) {
      const n = (
          !e || ("UL" !== e.nodeName && "OL" !== e.nodeName) ? U.children(e, ".active") : U.find(":scope > li > .active", e)
        )[0],
